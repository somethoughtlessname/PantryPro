...
function renderSettingsWindowBody(){
  ...
  if(activeTab==='pantry'){
    ...
    (function(){
      ...
      addSlider('partial','Partial','#C7824A'); addSlider('low','Low','#5A8DB8'); addSlider('critical','Critical','#C85A5A');
